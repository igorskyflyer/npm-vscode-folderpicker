...
Hello, thank you for using VS Code FolderPicker! 🙋🏻‍♂️  
...
- Check the [`README`](https://github.com/igorskyflyer/npm-vscode-folderpicker/blob/main/README.md) for documentation and setup guidance.
- Search [`issues`](https://github.com/igorskyflyer/npm-vscode-folderpicker/issues) to see if your question has already been answered.
...
- open a [`new issue`](https://github.com/igorskyflyer/npm-vscode-folderpicker/issues) using the appropriate issue template and with the label of `bug`,
- include details such as:
   - steps to reproduce
   - VS Code FolderPicker version
...
Do so by:
- opening a [`new issue`](https://github.com/igorskyflyer/npm-vscode-folderpicker/issues) using the appropriate issue template and with the label of `feature`,
...
- See [`CONTRIBUTING.md`](https://github.com/igorskyflyer/npm-vscode-folderpicker/blob/main/CONTRIBUTING.md) for guidelines.
...
If you'd like to support further development of VS Code FolderPicker:
...
<div align="center">
  Thank you for using VS Code FolderPicker!
  <br>
